    ...
    public boolean process(File in, File out) {
       ...
       for(int i=0; i<pi.getColumns(); i++)
                ...
                for(int j1=0; j1<pi.getLines(); j1++) {
                       moutA.set(i,j,moutA.get(i,j)+ match(new Circle(pi,i,j,0,r), new Circle(pi, i1, j1,0,r)));
                                             
                moutB.set(i1,j1,moutB.get(i1,j1)+match(new Circle(pi,i1,j1,0,r),new Circle(pi,i,j,0,r)));
